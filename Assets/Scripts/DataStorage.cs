...
public class DataStorage : MonoBehaviour {
    ...
    2 - talked to priest, haven't entered dungeon
    3 - completed wax dungeon, haven't talked to priest
    4 - completed wax dungeon, talked to priest

    int blessings;
    0 - died the first time (need a way to differentiate which part the player died from)
    1 - already introduced to blessings
